...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/skywalker1807/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/skywalker1807/LARBS/master/progs.csv"
